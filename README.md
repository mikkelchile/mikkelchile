...
Mining Engineering student at **Pontificia Universidad Católica de Chile**, currently developing an MSc thesis focused on hydrometallurgical routes for lithium extraction from spodumene concentrates.
...
`Hydrometallurgy` · `Mineral Processing` · `Lithium` · `Critical Minerals`
`Geomechanics` · `Mine Planning` · `Technical Writing`
...
🪨 **Luksic Rock Project** — geomechanical characterization and stability analysis
♻️ **Urban Hydrometallurgy** — metal recovery from end-of-life brake pads
⛏️ **Mine Planning** — pit optimization and scenario analysis
